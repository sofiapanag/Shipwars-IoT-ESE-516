...
/** Wi-Fi AP Settings. */
#define MAIN_WLAN_SSID "Mi 11"//"Kim's Home"             /**< Destination SSID. Change to your WIFI SSID */
#define MAIN_WLAN_AUTH M2M_WIFI_SEC_WPA_PSK /**< Security manner */
#define MAIN_WLAN_PSK "87654321"//"25051997"            /**< Password for Destination SSID. Change to your password. Please dont hack my WiFi router */
